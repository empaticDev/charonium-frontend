...
export default function TextBlock(props) {
    ...
    let className = cx({
		textBlock: true,
        'spacing--medium': props.spacing != undefined && props.spacing === 'medium' ? true : false,
	})
    ...
    return (
        ...
        { props.title && <PartialHeading title={props.title} label={props.label} heading={props.heading} /> }
